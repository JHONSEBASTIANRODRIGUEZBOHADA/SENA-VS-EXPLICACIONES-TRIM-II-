...
namespace EXPLICACION_1     //SE USA PARA ORGANIZAR ARCHIVOS
{
    class Mainprogram     //NOMBRE DE LA CLASE DE TIPO CLASS
    {
        public  static void Main(string[]args)     //void= NO RETORNA NINGUN VALOR
        {
            ...
            Datos myData = new Datos();     //();USANDO CONSTRUCTOR VACIO   //CREAR UNA INSTANCIA   //SE CREA E INSTANCIA UN OBJETO LLAMADO myData DE TIPO DATOS
            myData.Color = "green";     //SE INSTANCIA //myData= OBJETO DE CLASE //.= LLAMA A LOS ATRIBUTOS O METODOS //== INICIALIZA LOS ATRIBUTOS
            Console.WriteLine(myData.Color);     //Console= CLASE //WriteLine= METODO
        }
    }
}